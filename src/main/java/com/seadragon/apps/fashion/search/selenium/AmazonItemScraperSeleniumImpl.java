package com.seadragon.apps.fashion.search.selenium;
 ...
 */
public class AmazonItemScraperSeleniumImpl implements Scraper<Item> {
    private static final Logger logger = LoggerFactory.getLogger(AmazonItemScraperSeleniumImpl.class);
